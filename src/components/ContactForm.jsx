    ...
    const ContactForm = () => {
      ...
      const companyContacts = [
        { icon: <Phone size={20} className="text-primary"/>, text: "(044) 374124 | 949208893 | 949122435", href: "tel:044374124" },
            ...
            <div className="grid md:grid-cols-2 gap-12 items-start">
              ...
              >
                ...
                {companyContacts.map(contact => (
                  <a key={contact.text} href={contact.href} target={contact.href.startsWith('http') ? '_blank' : undefined} rel={contact.href.startsWith('http') ? 'noopener noreferrer' : undefined} className="flex items-start space-x-4 p-4 bg-muted/30 rounded-lg hover:shadow-md transition-shadow group">
                 ...
                 <div className="mt-8 rounded-lg overflow-hidden shadow-xl">
                  <img  class="w-full h-64 object-cover" alt="Mapa de ubicación de Extintores Bruce E.I.R.L." src="https://images.unsplash.com/photo-1700839174658-71acb2c069b5" />
                 </div>
              </motion.div>
            </div>
          </div>
